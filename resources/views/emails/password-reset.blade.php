...
<head>
  ...
  <style>
    .hover-bg-_009378-80:hover {
      background-color: rgb(0 147 120 / 0.8) !important
    }
        ...
        <tr>
          <td style="width: 552px; max-width: 100%">
            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px; text-align: center">
                  <a href="https://smpbooster.com">
                    <img src="{{asset('assets/images/logo.png')}}" width="112" alt="SMP Booster" style="max-width: 100%; vertical-align: middle">
                  </a>
                </td>
              </tr>
            </table>
            <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                  <h2 style="margin: 0 0 24px; font-size: 20px; font-weight: 600; color: #0f172a">
                    Hello {{ $first_name }},
                  </h2>
                  ...
                  <div>
                    <a href="{{ $url }}" style="display: inline-block; text-decoration: none; margin: 0 0 24px; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 8px; color: #fffffe; background-color: #227d53" class="hover-bg-_009378-80">
                  ...
                  <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                    This password reset link will expire in {{ $count }} minutes. If you did not request a password reset, no further action is required.
                  </p>
                  <div role="separator" style="line-height: 24px">&zwj;</div>
                  <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569">
                    Thanks,
                    <br>
                    <span style="font-weight: 600">SMP Booster Team</span>
                  </p>
